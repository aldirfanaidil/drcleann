...
<head>
    ...
    <title>Edit Pengguna - <?= APP_NAME ?></title>
        ...
        <div class="max-w-7xl mx-auto px-4">
            ...
            <div class="bg-white p-5 rounded-lg shadow mb-8 flex justify-between items-center">
                <div class="flex items-center">
                    ...
                    <div>
                        <h4 class="text-2xl font-semibold text-gray-800">Edit Pengguna</h4>
                        <small class="text-gray-600">Ubah data pengguna</small>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="p-6">
                    <form method="POST" action="?page=user_edit&id=<?= $user['id'] ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="role" required
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#7B2C2C] focus:border-transparent">
                                    <option value="kasir" <?= (($_SESSION['old']['role'] ?? $user['role']) === 'kasir') ? 'selected' : '' ?>>Kasir</option>
                                    <option value="admin" <?= (($_SESSION['old']['role'] ?? $user['role']) === 'admin') ? 'selected' : '' ?>>Admin</option>
                                    <option value="superuser" <?= (($_SESSION['old']['role'] ?? $user['role']) === 'superuser') ? 'selected' : '' ?>>Superuser</option>
                                </select>
